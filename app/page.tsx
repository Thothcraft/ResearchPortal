...
export default function LandingPage() {
  ...
  const sensing = [
    { title: 'Radar', text: 'Presence and movement without identifiable imagery.', icon: Radar },
  ...
  return <main className="min-h-screen bg-slate-50 text-slate-950">
    <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5">
      <div className="flex items-center gap-2 font-semibold"><span className="rounded-lg bg-slate-950 px-2 py-1 text-white">T</span> Thoth</div>
    ...
    <section className="mx-auto grid min-h-[68vh] max-w-6xl items-center gap-12 px-5 py-16 lg:grid-cols-[1.2fr_.8fr]">
      <div><div className="text-xs font-bold uppercase tracking-[.2em] text-cyan-700">Raspberry Pi ambient intelligence</div><h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[.95] tracking-[-.055em] sm:text-7xl">Understand a space through wireless sensing.</h1><p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600">Thoth combines radar, Wi‑Fi sensing, and an optional camera in one local-first device for responsive, privacy-conscious environments.</p><Link href="/auth" className="mt-8 inline-flex rounded-xl bg-cyan-300 px-5 py-3 font-semibold text-slate-950">Open Thoth Portal</Link></div>
