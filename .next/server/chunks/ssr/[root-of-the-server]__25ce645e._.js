...
;
;
function DeviceCard({ device, onToggleSensors, onOpenSettings }) {
...
class ApiService {
    ...
    connectToSensorStream(deviceId, onData) {
        ...
        this.socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2d$debug$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(`${WS_URL}/sensors/stream?device_id=${deviceId}`, {
            transports: [
                'websocket'
            ]
        });
...
function DevicesPage() {
    ...
    const handleToggleSensors = async (deviceId)=>{
        try {
            const device = devices.find((d)=>d.device_id === deviceId);
            if (device) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].controlSensors(deviceId, {
                ...
                // Update local state
                setDevices(devices.map((d)=>d.device_id === deviceId ? {
                        ...d,
                        sensors_enabled: !d.sensors_enabled
                    } : d));
            }
        } catch (error) {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$dom$2f$motion$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Manage and monitor your Thoth IoT devices"
                                }, void 0, false, {
                                    fileName: "[project]/app/devices/page.tsx",
                                    lineNumber: 107,
                                    columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25ce645e._.js.map