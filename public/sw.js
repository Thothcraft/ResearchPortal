...
self.addEventListener('fetch', (event) => {
  ...
  if (cacheableApi || event.request.mode === 'navigate') {
    // Clone synchronously: by the time caches.open() resolves the delivered
    // response body is locked — clone() then throws "body is already used".
